  ...
  return (
    <section className="py-16 sm:py-24 border-t border-gray-100 overflow-hidden" id="iris">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Label */}
        <p className="text-xs font-bold uppercase tracking-widest text-orange-500 mb-4 text-center">
          AI-assistent
        </p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <button
              ...
              className="mt-2 self-start inline-flex items-center gap-2.5 px-6 py-3.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors shadow-sm"
            >
              {/* Sparkles icon */}
